...
if (document.getElementsByClassName('demo').length > 0) {
  ...
  e.errickson 
  ----------- 
  Person by day, asleep by night, enjoys building software, 
  enjoys breaking software, [Ctrl C] + [Ctrl V] champion.
...
There are 5 🐔 hidden on this site, find them for a reward.

  --> Welcome to errickson.ml. Have a look around.
  `;
  var speed = 10;
